...
export module FawnAlgebra.Aritmetics;
...
struct Vec
{
    ...
    explicit operator std::array<T, N>() const noexcept
    {
        return data;
    }
...
export using uint8 = int8_t;
export using uint16 = int16_t;
export using uint32 = int32_t;
export using uint64 = int64_t;
