...
public:
    ...
    constexpr explicit dekker_double( double A, double a ) : A { A }, a { a }
    {
    }
    constexpr explicit dekker_double( long long int value ) : a { static_cast<double>( value ) }
    {
    }
    constexpr ~dekker_double()                                 = default;
...
private:
    ...
    */
    static constexpr dekker_double&& Mul12( double valueA, double valueB )
    {
