...
public:
    ...
    constexpr explicit dekker_double( const double A, const double a ) : A { A }, a { a }
    {
    }
...
private:
    ...
    [[nodiscard]] static constexpr dekker_double Split( const double value ) noexcept
    {
        static constexpr double SCALE { 134217729 };
    ...
    {
        static constexpr unsigned long long MASK { ~0x3ffffffU };
