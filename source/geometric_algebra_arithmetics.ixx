...
struct Quaternion
{
    ...
    constexpr explicit Quaternion(const T w_val) noexcept
        : w{w_val}
    {
    }
    ...
    [[nodiscard]] constexpr bool IsApproximate(const Quaternion& other) const noexcept
    {
        if constexpr (std::is_floating_point_v<T>)
        {
            ...
            return (dw > -EPSILON && dw < EPSILON) && (dx > -EPSILON && dx < EPSILON) && (dy > -EPSILON && dy < EPSILON) && (dz > -EPSILON && dz < EPSILON);
        }
...
struct Odd
{
    ...
    {
        lhs.c1.return Even<TT>{-lhs.w * rhs.w + lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z, -lhs.w * rhs.x - lhs.x * rhs.w - lhs.y * rhs.z + lhs.z * rhs.y,
                               -lhs.w * rhs.y - lhs.y * rhs.w - lhs.z * rhs.x + lhs.x * rhs.z, -lhs.w * rhs.z - lhs.z * rhs.w - lhs.x * rhs.y + lhs.y * rhs.x};
    }
...
struct Odd
{
    ...
    friend constexpr Even<TT> operator*(const Odd<TT>& lhs, const Odd<VV>& rhs)
    {
        return Even<TT>{-lhs.w * rhs.w + lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z, -lhs.w * rhs.x - lhs.x * rhs.w - lhs.y * rhs.z + lhs.z * rhs.y,
                        -lhs.w * rhs.y - lhs.y * rhs.w - lhs.z * rhs.x + lhs.x * rhs.z, -lhs.w * rhs.z - lhs.z * rhs.w - lhs.x * rhs.y + lhs.y * rhs.x};
    }
